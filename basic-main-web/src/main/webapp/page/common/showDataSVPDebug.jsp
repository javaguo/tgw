...
<html>
  <head>
	...
	<script type="text/javascript">
	console.log("refreshList_${identifier}前-----aabb");
<%-- 刷新列表数据方法 --%>
...
dataStore_${identifier}.load({params:{page:1,start:0,limit:${pageSize}}});
console.log("onReady load----结束");
if( Ext.getCmp('right_tab_${identifier}') ){
	console.log("onReady getCmp  if");
}else{
	console.log("onReady getCmp  else");
}
if( pagePanel${identifier} ){
	console.log("onReady pagePanel${identifier}  if");
}else{
	console.log("onReady pagePanel${identifier}  else");
}
try{
Ext.getCmp('right_tab_${identifier}').add( pagePanel${identifier} );	
}catch(err){
	console.log("onReady----出错了");
}

	console.log("onReady----结束");
});	
</script>
